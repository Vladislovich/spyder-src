...
int main() {
    ...
    // Set the parameters
    gp3.setSearchRadius(0.25);  // Set the maximum distance between connected points (adjust as needed) 0.25
    ...
    gp3.setMaximumSurfaceAngle(M_PI / 4);  // Maximum angle (in radians) between surface normals
    gp3.setMinimumAngle(M_PI / 18);  // Minimum angle for a triangle
    gp3.setMaximumAngle(2 * M_PI / 3);  // Maximum angle for a triangle
